...
local appposx = "115" -- 115, 413, 716
local xmlpos = "197" -- 197, 483, 769
local qlapp = "app01" -- app01, app02, app03
local next = "app02" -- app01, app02, app03
local cursys = "sys-1.txt"
local curreadout = "z-1.txt"
local user0 = "user5/"
  ...
  if not System.doesFileExist(replaceid.."sys-3.txt") then
	...
	if Controls.check(pad, SCE_CTRL_CROSS) and not Controls.check(oldpad, SCE_CTRL_CROSS) then
		if appfold[i].directory then
			...
			Graphics.freeImage(user1app01)
			user1app01 = Graphics.loadImage(user.."" ..qlapp.. ".png")
