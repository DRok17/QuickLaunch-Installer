...
local appposx = "716" -- 115, 413, 716
local xmlpos = "769" -- 197, 483, 769
local qlapp = "app03" -- app01, app02, app03
local next = "app01" -- app01, app02, app03
local cursys = "sys-3.txt"
local curreadout = "z-3.txt"
local user0 = "user5/"
  ...
  if not System.doesFileExist(replaceid.."sys-3.txt") then
	...
	if Controls.check(pad, SCE_CTRL_CROSS) and not Controls.check(oldpad, SCE_CTRL_CROSS) then
		if appfold[i].directory then
			...
			Graphics.freeImage(user1app03)
			user1app03 = Graphics.loadImage(user.."" ..qlapp.. ".png")
